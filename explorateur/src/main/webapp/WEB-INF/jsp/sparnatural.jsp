...
<html>
<head>
<title><fmt:message key="window.app" /> | <fmt:message key="sparnatural.window.title" /></title>
<meta charset="utf-8">
...
<body>
	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="col-sm-10">			
				<h1><fmt:message key="sparnatural.title" /></h1>
				<fmt:message key="sparnatural.sources" /> : ${data.sourcesDisplayString}<c:if test="${data.requiresFederation}">&nbsp;&nbsp;<small style="color:red;"><i class="fal fa-exclamation-triangle"></i>&nbsp;<fmt:message key="explore.sources.federatedWarning" /></small></c:if><br />
				<!--  
				<a href="<c:url value="/sparnatural" />"><small><i class="fal fa-angle-left"></i>&nbsp;<fmt:message key="explore.sources.change" /></small></a>
				-->
...
// 		 );
		 ...
		 $('#sparnatural').Sparnatural({
			...
			//config: RDFSpecificationProvider.build(345,"humanum-masa/config-openarchaeo-dev/federation/sparnatural-config.ttl","fr"),
